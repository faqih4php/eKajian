                ...
                <div class="col-xxl-8 mb-6 order-0">
                    <div class="card">
                        <div class="d-flex align-items-start row">
                            <div class="col-sm-7">
                                <div class="card-body">
                                    <h5 class="card-title text-primary mb-3">Selamat Pagi 🎉</h5>
                                    <p class="mb-6">Kamu ingin mengecek apa hari ini?<br>Membuat permohonan kajian atau melihat jadwal kajian?</p>

                                    <a href="{{ route('jadwal-kajian.index') }}" class="btn btn-sm btn-label-primary">Lihat
                                        Kajian</a>
                                    <a href="{{ route('request-kajian.create') }}" class="btn btn-sm btn-label-primary">Buat
                                        Permohonan</a>
                                </div>
                            </div>
