                ...
                <div class="col-md-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            @endif
                            <form action="{{ route('request-kajian.store') }}" method="POST">
                                @csrf
                                <div class="mb-4">
                                ...
                                <div class="mb-4">
                                    ...
                                    @enderror"
                                        name="nomer" id="nomer" value="{{ old('nomer') }}"
                                ...
                                <div class="mb-6">
                                    <button type="submit" class="btn btn-primary me-2">Buat Permohonan</button>
                                    @guest
                                        <a href="{{ route('guest.index') }}" class="btn btn-outline-secondary">Kembali</a>
                                    @else
